...
//       // Here you can handle the image upload logic, e.g., uploading to Cloudinary
//     }
//   };
...
//     await update(profileDetails?.username, selectedImage);
//   };

//   return (
//     <div className="transition-all duration-500 relative w-full h-full items-center scrollbar-none overflow-y-auto overflow-x-hidden md:border-r border-gray-400">
...
//           </label>
//         </div>
//         <p className="text-lg font-extralight py-3">{profileDetails?.email}</p>
